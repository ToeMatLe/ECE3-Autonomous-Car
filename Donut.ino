...
int donutCount = 0;
const long DONUT_COUNTS1 = 225;   // <-- adjust after testing
const long DONUT_COUNTS2 = 730 + DONUT_COUNTS1;   // <-- adjust after testing
const long DONUT_COUNTS3 = 220 + DONUT_COUNTS2;   // <-- adjust after testing
